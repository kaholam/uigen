            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                ...
                <div className="h-14 border-b border-neutral-200/60 px-6 flex items-center justify-between bg-neutral-50/50">
                  <div className="inline-flex bg-white/60 border border-neutral-200/60 p-0.5 h-9 shadow-sm rounded-lg">
                    <button
                      onClick={() => setActiveView("preview")}
                      className={`inline-flex items-center justify-center rounded-md border px-4 text-sm font-medium transition-all ${
                        activeView === "preview"
                          ? "bg-white text-neutral-900 shadow-sm border-neutral-200/60"
